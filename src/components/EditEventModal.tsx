    ...
    >
      <div className="relative w-full max-w-2xl max-h-[90vh] bg-gray-900 rounded-2xl border border-gray-800 shadow-2xl overflow-hidden animate-modal-fade-in">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-800">
          <h2 id="edit-event-title" className="text-2xl font-bold text-white">
            Edit Event
          </h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto max-h-[calc(90vh-140px)]">
          <div className="p-6 space-y-6">
            ...
            {/* Event Title */}
            <div>
              <label htmlFor="edit-title" className="flex items-center text-sm font-medium text-gray-300 mb-2">
            ...
            {/* Description */}
            <div>
              <label htmlFor="edit-description" className="flex items-center text-sm font-medium text-gray-300 mb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="edit-date" className="flex items-center text-sm font-medium text-gray-300 mb-2">
              ...
              <div>
                <label htmlFor="edit-time" className="flex items-center text-sm font-medium text-gray-300 mb-2">
            ...
            {/* Location */}
            <div>
              <label htmlFor="edit-location" className="flex items-center text-sm font-medium text-gray-300 mb-2">
            ...
            {/* Country */}
            <div>
              <label htmlFor="edit-country" className="flex items-center text-sm font-medium text-gray-300 mb-2">
                <MapPin size={16} className="mr-2 text-purple-500" />
                Country *
              </label>
              <select
            ...
            {/* Organizer */}
            <div>
              <label htmlFor="edit-organizer" className="flex items-center text-sm font-medium text-gray-300 mb-2">
            ...
            {/* Category */}
            <div>
              <label htmlFor="edit-category" className="flex items-center text-sm font-medium text-gray-300 mb-2">
                <Tag size={16} className="mr-2 text-purple-500" />
                Category *
              </label>
              <select
            ...
            {/* Image Upload */}
            <div>
              <label htmlFor="edit-image" className="flex items-center text-sm font-medium text-gray-300 mb-2">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Optional: Upload a new image to replace the current one (JPG, PNG, GIF)
              </p>
            </div>
          </div>
